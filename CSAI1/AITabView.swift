...
//  optional Organization header, and debug logging
//  Make sure your simulator has internet or use a real device.
//
...
struct AITabView: View {
    ...
    // Embed your new key here for testing
    ...
    // If you have an Organization ID, set it here (optional)
    // private let openAIOrgID = "org-YourOrgIDHere"  // Example
...
extension AITabView {
    ...
    /// Updated sendMessage that uses OpenAI's Chat Completion API with ephemeral session.
    private func sendMessage() {
        ...
        Task {
            do {
                ...
                // Debug: Print the error details to the console.
    ...
    /// Fetches a response from OpenAI's Chat Completion API with ephemeral URLSession and debug logging.
    private func fetchAIResponse(for userInput: String) async throws -> String {
        guard let url = URL(string: "https://api.openai.com/v1/chat/completions") else {
            throw URLError(.badURL)
        }
        
        // Use ephemeral config to avoid potential caching/proxy issues
        ...
        // If you want to specify your org ID (optional), uncomment:
        // request.addValue(openAIOrgID, forHTTPHeaderField: "OpenAI-Organization")
        
        // Add explicit annotation so Swift knows this is a [String: Any] dictionary.
        ...
        // Debug logging: Print HTTP status code and response body.
