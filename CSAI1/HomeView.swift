...
struct HomeView: View {
    ...
    var body: some View {
        ZStack {
            // Background gradient – you can replace this with FuturisticBackground() if desired.
            LinearGradient(
        ...
        // Present the actual SettingsView sheet.
        .sheet(isPresented: $showSettings) {
            SettingsView()
        }
        // Notifications sheet remains as a placeholder.
        .sheet(isPresented: $showNotifications) {
            Text("Notifications Placeholder")
                .font(.title)
                .padding()
        }
        // Force the color scheme to follow the user’s setting from AppTheme.
