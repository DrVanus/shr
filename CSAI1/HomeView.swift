    ...
    var body: some View {
        ZStack {
            ...
            NavigationView {
                ...
                // Remove any default scroll background so our theme shows through
        ...
        .sheet(isPresented: $showSettings) {
            SettingsView()  // Uses your existing SettingsView file
        }
        ...
        // Apply the color scheme from your theme settings
