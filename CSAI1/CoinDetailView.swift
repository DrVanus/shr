...
enum ChartInterval: String, CaseIterable {
    ...
    // We slightly increased the limit for 4H to get more data points.
...
struct CoinDetailView: View {
        ...
        ZStack {
            ...
            HStack {
                ...
                VStack(spacing: 2) {
                    ...
                    // Price in yellow to match theme – now using the updated formatting.
    ...
    // MARK: - Trade Button (pinned at bottom)
    ...
    // MARK: - Price Formatter (Updated)
    private func formatPrice(_ value: Double) -> String {
        // Updated to use a minimum of 2 decimals and up to 8 when value is below 1.0.
...
struct CoinDetailCustomChart: View {
    ...
    private var chartContent: some View {
        ...
        // We increased axis label count for 4H so we don't just get 1 label
            ...
            if showCrosshair, let cVal = crosshairValue {
                ...
                .annotation(position: .top) {
                    VStack(spacing: 2) {
                        ...
                        // Updated formatting for the chart annotation price.
    ...
    // MARK: - Price Formatter for Chart (Updated)
    private func formatWithCommas(_ value: Double) -> String {
        // Updated to use the same formatting style as formatPrice(_:)
        guard value > 0 else { return "$0.00" }
        let formatter = NumberFormatter()
        formatter.numberStyle = .decimal
        if value < 1.0 {
